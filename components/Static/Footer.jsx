                ...
                <div className="pt-10 mx-auto">
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                <img src="/img/Gamechez.png" className="rounded-full w-12" />
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <a href="https://discord.gg/gamechez" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Destek Sunucusu
                                </a>
                            </div>
                            <div>
                                <a href="https://discord.com/oauth2/authorize?client_id=1158516555546628126&permissions=8&integration_type=0&scope=bot+applications.commands%20bot" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Davet Et
                                </a>
                            </div>
                        </div>
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://www.youtube.com/@Archez_">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                    ...
                    <div className="mt-10 grid content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                        <p className="text-white text-center sm:text-left text-opacity-50">
                            {new Date().getFullYear()} &copy; Gamechez
                        </p>
